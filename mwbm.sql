...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2017 at 03:10 PM
...
INSERT INTO `categories` (`id_category`, `id_language`, `category_icon`, `category_name`, `position`, `created_on`) VALUES
(1, 2, 'http://192.168.0.101/menwillbemen_web/images/icon/home-icon.png', 'चावट जोक्स 😂😂', 0, '2017-05-06 10:53:37'),
(2, 2, 'http://192.168.0.101/menwillbemen_web/images/icon/home-icon.png', 'नवरा बायको', 0, '2017-05-06 10:53:40'),
(3, 2, 'http://192.168.0.101/menwillbemen_web/images/icon/home-icon.png', 'टाईमपास', 0, '2017-05-06 10:53:43'),
(4, 1, 'http://192.168.0.101/menwillbemen_web/images/icon/home-icon.png', 'TimePass', 0, '2017-05-06 10:53:43');
...
(1, 'footer_image', '1', 1),
(2, 'left_header_image', 'http://192.168.1.101/menwillbemen_web/images/background/header.jpg', 1),
(3, 'right_header_image', 'http://192.168.1.101/menwillbemen_web/images/background/header.jpg', 1),
(4, 'color-blue', '#FF33B5E5', 1),
(5, 'color-red', '#FFFF4444', 1),
(6, 'background_image', 'http://192.168.1.101/menwillbemen_web/images/background/doodle3.png', 1),
(7, 'language_en', 'English', 1),
(8, 'language_ma', 'मराठी', 1),
(10, 'color-purple', '#9C27B0', 1),
(11, 'color-indigo', '#3F51B5', 1),
(12, 'color-teal', '#009688', 1),
(13, 'color-green', '#4CAF50', 1),
(14, 'color-lightgreen', '#8BC34A', 1),
(15, 'color-lime', '#CDDC39', 1),
(16, 'color-amber', '#FFC107', 1),
(17, 'color-orange', '#FF9800', 1),
(18, 'color-deeporange', '#E65100', 1),
(19, 'color-brown', '#795548', 1),
(20, 'color-grey', '#9E9E9E', 1),
(21, 'color-bluegrey', '#607D8B', 1),
(22, 'refresh_style', '24', 1),
(23, 'loading_more_style', '25', 1),
(24, 'interstitial_iterations', '15', 1),
(25, 'native_iterations', '5', 1);
...
INSERT INTO `users` (`id`, `fname`, `lname`, `phone`, `email`, `device_id`, `firebase_reg_id`, `password_hash`, `api_key`, `status`, `created_at`) VALUES
(1, 'guest', '', 0, 'guest@guest.com', 0, '', '$2a$10$5af01ca52dc386f6db472Oibc8c0motGEHT6TKR0ispt.YKIi9RH.', 'guest', 1, '2017-01-22 16:43:37'),
(2, 'admin', '', 0, 'admin@admin.com', 0, '', '$2a$10$5af01ca52dc386f6db472Oibc8c0motGEHT6TKR0ispt.YKIi9RH.', 'admin', 1, '2017-01-22 16:43:37'),
(27, '', '', 0, 'shivajikumbhar112@gmail.com', 2147483647, 'ct4HE8EFz7o:APA91bFOgJEjVyk7HUYLlKhoVvYy3wmh4X8oYlVk0MKpMwtGfL8AhgJRfz1mcZQkCGslJvcYBb54mWFiW0rgiYOgtOZl0BEijTGsdkhho4MxNY3-WqRsHRTXm-L8pKbPCM1AyIqlHOdS', '$2a$10$a8c72bdb0d6c609766d31uWVBG865m2l7R2l2zdVloFRtPPuKA7j.', '372b4bbd713a2e924a311cbe3fe22049', 1, '2017-05-13 20:19:31'),
(28, '', '', 0, 'sourabhkumbhar@gmail.com', 2147483647, 'dluBJ0IfYuE:APA91bGyZ91xxTIlqTDzXPUVjdHkSqwn79zrK4ToGPCBFz3UBiJ_r1b8UJLiWLiegjgJrDp7h0UgOuTTFwpo3qPbLFdh0ASVAyxJ9JUuTrLIaSi-Kt8R2ray1wM71n7kKjU9s17XnfJo', '$2a$10$fda95d1d95f958e97ae4eOQ7eeKWCN8ktpzzKToFb8gPRQVw4uiQe', 'b186dfcf42c31fbbdd7dd39af505a85a', 1, '2017-05-13 20:32:09'),
(29, '', '', 0, '', 0, 'dF7dzMFHqUE:APA91bE5q2fJMbOxqBFUyyTNE17MRo0AisCuUfth1aqzert64BczyF79qku6P2DhhsaxSdzG65GEq-0kN9pFCDDPt5kcw3-jEkuryFdPxDi4Z-TJmNHwC9rZzrx3G41uIW4d5-5ZFXTh', '$2a$10$918124ded63556b881d45uChT2CS84WglSAGX3sIWscWOS7IgYClO', '6bca88e8fdf4dbb9d4a2c1e8be4dda85', 1, '2017-05-16 22:15:42');
...
INSERT INTO `user_post_likes` (`id`, `id_user`, `id_post`, `created_at`) VALUES
(7, 28, 10, '2017-05-14 00:24:46'),
(8, 28, 11, '2017-05-14 04:38:59'),
(9, 28, 10, '2017-05-14 16:50:59'),
(79, 1, 11, '2017-05-17 12:49:28');
